...
export const siteMetadata = {
    ...
    language: 'en-us',
    theme: 'system',
    siteUrl: 'https://cadwonder.vercel.app',
    siteLogo: '/logo.png',
    socialBanner: '/social-banner.png',
    email: 'harshkumarmeena31@gmail.com',
    phone: '+91-8955579775',
    address: 'Aurobindo, MNIT Jaipur, Malaviya Nagar, Jaipur, Rajasthan, 302017, India',
    github: 'https://github.com/nandkishor-kumawat',
