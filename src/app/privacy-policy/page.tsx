...
const page = () => {
    return (
        <div className="max-w-4xl sm:mx-auto p-6 px-8 bg-white shadow-lg rounded-lg my-10 mx-1 [&_ul]:list-disc [&_ul]:ml-6 [&_ul]:space-y-2 privacy-policy">
            <h1 className="text-center mb-2 text-blue-600">Privacy Policy</h1>
            <p className="text-sm text-gray-500 text-center mb-8">Last updated: September 03, 2024</p>
            <div className="space-y-3 [&_p]:my-1.5 [&_p]:text-justify">
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to cadwonder, accessible from
                                <a
                                    href="https://cadwonder.vercel.app/"
                                    rel="external nofollow noopener"
                                    target="_blank"
                                >https://cadwonder.vercel.app/</a
                                >
                            </p>
                        </li>
                        <li>
